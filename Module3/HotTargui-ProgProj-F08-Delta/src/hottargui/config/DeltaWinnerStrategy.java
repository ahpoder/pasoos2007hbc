...
/**
 * DeltaTargui implementation of the WinnerStrategy.
 *
 * In the DeltaTargui specification the winner is the player with the largest revenue after the final round.
 * If two players has identical revenue, the Saltmine owner wins.
 *
 */
public class DeltaWinnerStrategy implements WinnerStrategy {

    private Game game;

	public DeltaWinnerStrategy(Game game) {
		this.game = game;
	}
