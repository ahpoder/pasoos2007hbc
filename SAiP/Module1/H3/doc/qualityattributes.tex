...
The scenarios may be further clarified in order to include the aspects of availability and performance, as shown in tables \ref{tab:availability} and \ref{tab:performance} below:
