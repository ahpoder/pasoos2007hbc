...
\subsection{Tactics}
\subsection{Availability}
We will use a passive redundancy system for the http service in order to handle the response measurement. 
We consider the risk of hardware failure to small to use hardware redundancy, given the expected low amount of traffic on the system.
\subsection{Usability}
